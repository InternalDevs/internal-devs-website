...
export function ServicesSection() {
  return (
    <section id="services" className="py-24 lg:py-32 bg-background relative section-divider">
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        ...
        <div className="mt-16 grid lg:grid-cols-3 gap-8">
          {services.map((service, index) => (
            <ScrollReveal key={index} delay={0.1 * (index + 1)} variant="scale">
              <div className="group relative p-8 bg-card border border-border rounded-2xl hover:border-foreground/20 transition-all duration-300 h-full">
                {/* Icon */}
